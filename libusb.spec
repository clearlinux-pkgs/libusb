...
Version  : 1.0.25
Release  : 26
URL      : https://sourceforge.net/projects/libusb/files/libusb-1.0/libusb-1.0.25/libusb-1.0.25.tar.bz2
Source0  : https://sourceforge.net/projects/libusb/files/libusb-1.0/libusb-1.0.25/libusb-1.0.25.tar.bz2
...
%prep
%setup -q -n libusb-1.0.25
cd %{_builddir}/libusb-1.0.25
pushd ..
cp -a libusb-1.0.25 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643663356
...
cp %{_builddir}/libusb-1.0.25/COPYING %{buildroot}/usr/share/package-licenses/libusb/caeb68c46fa36651acf592771d09de7937926bb3
pushd ../build32/
%make_install32
