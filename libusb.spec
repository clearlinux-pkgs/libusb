...
Source0  : http://downloads.sourceforge.net/libusb/libusb-1.0.21.tar.bz2
...
%prep
%setup -q -n libusb-1.0.21
pushd ..
cp -a libusb-1.0.21 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1512429993
