...
Source0  : https://sourceforge.net/projects/libusb/files/libusb-1.0/libusb-1.0.26/libusb-1.0.26.tar.bz2
Source1  : https://sourceforge.net/projects/libusb/files/libusb-1.0/libusb-1.0.26/libusb-1.0.26.tar.bz2.asc
...
%prep
%setup -q -n libusb-1.0.26
cd %{_builddir}/libusb-1.0.26
pushd ..
cp -a libusb-1.0.26 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649703956
...
cp %{_builddir}/libusb-1.0.26/COPYING %{buildroot}/usr/share/package-licenses/libusb/caeb68c46fa36651acf592771d09de7937926bb3
pushd ../build32/
%make_install32
